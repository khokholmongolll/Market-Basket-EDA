...
*   `/notebooks`: Jupyter ноутбук с очисткой данных и расчетом Apriori.
*   `/viz`: Ссылка на интерактивный дашборд Tableau.
*   `/docs`: BPMN-схема процесса и финальная презентация
